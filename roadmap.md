...
- [x] Aurora WebGL background (FBM noise, cursor + scroll-velocity, OKLCH-safe)
- [x] Scroll-reactive marquee (velocity skew + reversal)
- [x] Mask-reveal section headings + count-up case-study metrics
- [x] Cursor spotlight + route-transition curtain (/, /lab, /resume)
- [x] 2. Hero split-letter reveal + scramble synced to preloader
